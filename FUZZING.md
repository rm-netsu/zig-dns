...
13. operational EDNS replay over arbitrary COOKIE/KEEPALIVE/EDE/EXPIRE/UPDATE-LEASE/ZONEVERSION/MQTYPE payloads plus generated typed round trips;
...
- `edns.Opt.fromRecord` + option iteration, including typed COOKIE/KEEPALIVE/EDE/EXPIRE/UPDATE-LEASE/ZONEVERSION/MQTYPE parsers;
- `svcb.validateRecord`;

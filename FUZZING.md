...
13. operational EDNS replay over arbitrary COOKIE/KEEPALIVE/NSID/PADDING/EDE/EXPIRE/REPORT-CHANNEL/UPDATE-LEASE/ZONEVERSION/MQTYPE payloads plus generated typed round trips and block-padding boundary properties;
...
- `edns.Opt.fromRecord` + option iteration, including typed COOKIE/KEEPALIVE/NSID/PADDING/EDE/EXPIRE/REPORT-CHANNEL/UPDATE-LEASE/ZONEVERSION/MQTYPE parsers;
- `svcb.validateRecord`;

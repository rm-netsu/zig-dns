...
- Add RFC 9859 DSYNC (TYPE 66) parsing/building, forward-compatible scheme handling, bounded endpoint-discovery name transforms, and generalized CDS/CSYNC NOTIFY events without transport ownership.
